...
* 🔧 Soporte y soluciones informáticas

## 📌 Proyectos recientes

* Desarrollo de proyectos web modernos utilizando HTML, CSS y Python.
* Creación de herramientas y soluciones tecnológicas para optimizar tareas cotidianas.
